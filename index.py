                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        ...
                        dbc.Col([
                            dcc.Dropdown(
                                id='select_estado2',
                                value=df_main.at[df_main.index[6], 'ESTADO'],
                                clearable=False,
                                options=[{'label': x, 'value': x} for x in df_main.ESTADO.unique()
                                ], style={'background-color': 'rgba(0,0,0,0.3'})
                        ], sm=10, md=6)
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                ...
                ],className='g-1', style={'height':'20%', 'justfy-content': 'center'})
            ],style=tab_card)
        ])
    ])
...
def func(data, toggle):
    ...
    final_df.columns = ['maximo', 'minimo']
...
@app.callback(
    ...
    State('controller', 'data'), prevent_initial_callbacks=True
)
